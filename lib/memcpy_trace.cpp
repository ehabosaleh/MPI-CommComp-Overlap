                                  ...
                                  size_t count, cudaMemcpyKind kind)
{
    ...
    fprintf(stderr,
            "[CUDA_COPY_TRACE] rank=%d pid=%d cudaMemcpy kind=%s bytes=%zu\n",
...
extern "C" cudaError_t cudaMemcpyAsync(void *dst, const void *src,
                                       ...
                                       cudaStream_t stream)
{
    using fn_t = cudaError_t (*)(void *, const void *, size_t,
    ...
    fprintf(stderr,
            "[CUDA_COPY_TRACE] rank=%d pid=%d cudaMemcpyAsync kind=%s bytes=%zu\n",
            get_rank(), getpid(), kind_str(kind), count);
    fflush(stderr);
                                 ...
                                 size_t bytes)
{
    ...
    fprintf(stderr,
            "[CUDA_COPY_TRACE] rank=%d pid=%d cuMemcpyDtoH bytes=%zu\n",
                                 ...
                                 size_t bytes)
{
    ...
    fprintf(stderr,
            "[CUDA_COPY_TRACE] rank=%d pid=%d cuMemcpyHtoD bytes=%zu\n",
            get_rank(), getpid(), bytes);
    fflush(stderr);
                                      ...
                                      size_t bytes, CUstream stream)
{
    ...
    fprintf(stderr,
            "[CUDA_COPY_TRACE] rank=%d pid=%d cuMemcpyDtoHAsync bytes=%zu\n",
            get_rank(), getpid(), bytes);
    fflush(stderr);
                                      ...
                                      size_t bytes, CUstream stream)
{
    ...
    fprintf(stderr,
            "[CUDA_COPY_TRACE] rank=%d pid=%d cuMemcpyHtoDAsync bytes=%zu\n",
            get_rank(), getpid(), bytes);
    fflush(stderr);
...
extern "C" CUresult cuMemcpy(CUdeviceptr dst, CUdeviceptr src, size_t bytes)
{
    ...
    fprintf(stderr,
            "[CUDA_COPY_TRACE] rank=%d pid=%d cuMemcpy bytes=%zu\n",
            get_rank(), getpid(), bytes);
    fflush(stderr);
                                  ...
                                  size_t bytes, CUstream stream)
{
    ...
    fprintf(stderr,
            "[CUDA_COPY_TRACE] rank=%d pid=%d cuMemcpyAsync bytes=%zu\n",
            get_rank(), getpid(), bytes);
    fflush(stderr);
