...
#define VECTOR_DIM_MEM (ELEMS_PER_PASS * MAX_UNIQUE_PASSES*1000UL)
#define VECTOR_DIM_COMP 1000000
...
double measure_gpu_compute_bound_kernel(float*d_a,cudaStream_t stream, int grid, int block,size_t n,int repeat,int inner_iters,int req_count, MPI_Request *reqs,int do_progress,memory_mode_t mode);
